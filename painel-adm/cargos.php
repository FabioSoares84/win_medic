...
<div class="row botao-novo">
	...
	<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Cargo</a>
    </div>
</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					echo 'Edição de Cargo';
				}else{
					$nome_botao = 'Salvar';
					echo 'Cadastro de Cargo';
				} ?>
			</h5>
		...
		<div class="modal-body">
			...
			<form method="post">
				...
				<div class="form-group">
					...
					<label for="exampleFormControlInput1">Nome Cargo</label>
